...
// 
var MEN_PHONE3_UNICODE_LAYOUT = {
    'id': 'menphone3_unicode',
    'direction': 'rtl',
    'force_direction': 'rtl',
    'title': 'Mende Kikakui Unicode 3',
    'mappings': {
        ',c': {
            '':  '{{S||~||\u0303}}{{\uD83A\uDCC7}}{{\uD83A\uDCC8}}{{\uD83A\uDCC9}}{{\uD83A\uDCCa}}' +
                '{{\uD83A\uDCCb}}{{\uD83A\uDCcc}}{{\uD83A\uDCCd}}{{\uD83A\uDCCe}}' +
...
google.elements.keyboard.loadme(MEN_PHONE3_UNICODE_LAYOUT);
menphone3_unicode = MEN_PHONE3_UNICODE_LAYOUT;

...
// Try shift for accented vowels, but also use combining accent.
  ...
  'mappings': {
    ...
    'l,cl': {
      '': '`1234567890-=' +
          ...
          '{{z\u0332}}{{x\u0332}}{{c\u0332}}{{v\u0332}}{{b\u0332}}{{n\u0332}}{{m\u0332}}{{ʌ\u0332}}{{ʔ\u0332}}.'
    },
    'sl,scl': {
      '': '~!@#$%^&*()_+' +
          '{{Q\u0332}}{{W\u0332}}{{E\u0332}}{{R\u0332}}{{T\u0332}}{{Y\u0332}}{{U\u0332}}{{I\u0332}}{{O\u0332}}{{P\u0332}}[]\\' +
          '{{A\u0332}}{{S\u0332}}{{D\u0332}}{{F\u0332}}{{G\u0332}}{{H\u0332}}{{J\u0332}}{{K\u0332}}{{L\u0332}};\'' +
          '{{Z\u0332}}{{X\u0332}}{{C\u0332}}{{V\u0332}}{{B\u0332}}{{N\u0332}}{{M\u0332}}{{\u0245\u0332}}?./'
    }
  }
};

// Load the layout and inform the keyboard to switch layout if necessary.
google.elements.keyboard.loadme(ONE4_LAYOUT);
one4 = ONE4_LAYOUT;
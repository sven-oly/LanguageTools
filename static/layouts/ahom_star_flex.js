...
// Implements Ahom keyboard based on Keyman Ahom Star
// Allows e/R/L before or after a consonant.

// https://keymanweb.com/#aho-ahom,Keyboard_ahom_star

var AHO_STAR_FLEX_LAYOUT = {
  'id': 'ahom_star_flex',
  'title': "Ahom Star before/after",
  'mappings': {
      '': {
          '':
  ...
  'transform' : {
    ...
    '(\ud805[\udf1d-\udf1f])(\ud805\udf26)\u001d?(\ud805[\udf00-\udf19])': '$3$1$2',
      ...
      // Consonant + e/R/L + 200c --> Consonant E
      '(\ud805[\udf00-\udf1a])\u200c(\ud805[\udf1d\udf1e\udf26])': '$1$2',
...
google.elements.keyboard.loadme(AHO_STAR_FLEX_LAYOUT);
aho_star_flex = AHO_STAR_FLEX_LAYOUT;

...
encoding_font_list = [
  {
    'font_path': '/fonts/Nsibibi/Akagu2020.ttf',
    'font_name': 'Akagu2020',
...
unicode_font_list = [
    {
        'family': 'Akagu2020',
        'longName': 'Akagu 2020',
        'source': '/fonts/Nsibibi/Akagu2020.ttf',
    },
]
...
class langInfo():
  def __init__(self):
    ...
    # Special home handler for Nsibibi
    self.custom_home_template = 'HTML/home_nsibibi.html'

...
class langInfo():
  def __init__(self):
    ...
    self.unicode_font_list = [
      ...
      {'family': 'NotoTangsaReg',
       'longName': 'Revised Noto Sans Tangsa Regular',
       'source': '/fonts/Tangsa/RevisedNoto/NotoSansTangsa-Regular.ttf',
       },
      {'family': 'NotoTangsaBold',
       'longName': 'Revised Noto Sans Tangsa Bold',
       'source': '/fonts/Tangsa/RevisedNoto/NotoSansTangsa-Bold.ttf',
       },
      {'family': 'NotoTangsaMedium',
       'longName': 'Revised Noto Sans Tangsa Medium',
       'source': '/fonts/Tangsa/RevisedNoto/NotoSansTangsa-Medium.ttf',
       },
      {'family': 'NotoTangsaSemiBold',
       'longName': 'Revised Noto Sans Tangsa Semi-Bold',
       'source': '/fonts/Tangsa/RevisedNoto/NotoSansTangsa-SemiBold.ttf',
       },

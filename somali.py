...
class langInfo:
    def __init__(self):
        ...
        self.unicode_font_list = [
            {'family': 'NotoSansSomaliOTF',
             'longName': 'Noto Sans Somali OTF',
             'source': '/fonts/Somali/NotoSans-Regular_Somali.otf',
            },
          {'family': 'NotoSerifSomali',
           'longName': 'Noto Serif Somali TTF',
           'source': '/fonts/Somali/NotoSans-Regular_Somali.ttf',
           },
          {'family': 'NotoSans',
           'longName': 'Noto Sans',
        ...
        self.kb_list = [
          ...
          {'shortName': 'so2',
           'longName': 'Somali 2',
           'instructions': 'Type "\\\\" after a, \u00e4, e, i, o, u for aa, \u00e4\u00e4, ee, ii, oo, uu'
           },
        ]

...
links = [
    ...
    {'linkText': 'Wikipedi page',
     'ref': 'https://en.wikipedia.org/wiki/Ember%C3%A1_Cat%C3%ADo',
    },
    {'linkText': 'Emberá Catío in ELP',
     'ref': 'https://www.endangeredlanguages.com/elp-language/2665'
     },
    # {'linkText': 'Ethnolog',
